...
const FollowPlatforms = () => {
  return (
    ...
    >
      <div className="my-2 flex flex-col items-center justify-center rounded-lg bg-blue-100 dark:bg-stone-500 px-4 py-2.5">
        <p className="text-center font-roboto text-sm italic md:text-base">
        ...
        <div className="mt-4 flex w-full items-center justify-center gap-8 px-4 md:gap-12">
          ...
          >
            ...
            <span className="md:hidden absolute width-1 height-1 overflow-hidden">
              WhatsApp
            </span>
          </Link>
